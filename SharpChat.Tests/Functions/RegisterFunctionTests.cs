...
public class RegisterFunctionTests
{
    ...
    public void RegisterFunction_NoDescription_Works()
    {
        ...
        SharpFunction function = cot.CreateSharpFunction(callbacks.MethodWithoutDescription);
    ...
    {
        var cot = new SharpFunctionFactory();
        SharpFunction function = cot.CreateSharpFunction(callbacks.MethodWithoutParams);
    ...
    {
        var cot = new SharpFunctionFactory();
        SharpFunction function = cot.CreateSharpFunction(callbacks.MethodWithSingleParam);
    ...
    {
        var cot = new SharpFunctionFactory();
        SharpFunction function = cot.CreateSharpFunction(callbacks.MethodWithEnum);
        ...
        parameter.EnumOptions.Should()
            .BeEquivalentTo(Enum.GetValues<DummyEnum>().Select(x => x.ToString()));
    }
    ...
    {
        var cot = new SharpFunctionFactory();
        SharpFunction function = cot.CreateSharpFunction(callbacks.MethodWithMultipleParams);
    ...
    {
        var cot = new SharpFunctionFactory();
        SharpFunction function = cot.CreateSharpFunction(callbacks.MethodWithComplexValue);
